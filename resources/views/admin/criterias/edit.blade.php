...
<div class="form-container">
    ...
    <div class="form-body">
        ...
        <form action="{{ route('admin.criterias.update', $criteria->id) }}" method="POST">
            ...
            <div class="form-group">
                <label class="form-label" for="criteria_weight">Bobot / Tingkat Kepentingan *</label>
                <select id="criteria_weight" name="criteria_weight" class="form-select" required>
                    <option value="">-- Pilih Tingkat Kepentingan --</option>
                    <option value="10" {{ old('criteria_weight', $criteria->criteria_weight) == '10' ? 'selected' : '' }}>Sangat Prioritas</option>
                    <option value="8"  {{ old('criteria_weight', $criteria->criteria_weight) == '8'  ? 'selected' : '' }}>Prioritas</option>
                    <option value="6"  {{ old('criteria_weight', $criteria->criteria_weight) == '6'  ? 'selected' : '' }}>Cukup Prioritas</option>
                    <option value="4"  {{ old('criteria_weight', $criteria->criteria_weight) == '4'  ? 'selected' : '' }}>Tidak Prioritas</option>
                    <option value="2"  {{ old('criteria_weight', $criteria->criteria_weight) == '2'  ? 'selected' : '' }}>Sangat Tidak Prioritas</option>
                </select>
